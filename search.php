...
$conn = mysqli_connect($dbServername, $dbUsername, $dbPassword, $dbName);
                ...
                if  (isset($_POST['submit-search'])) {
					...
					$sql = "SELECT * FROM social_table WHERE post_descriptor LIKE '%$search%'";
                    ...
                    $sql_2 = "SELECT * FROM other_students WHERE post_descriptor LIKE '%$search%'";
							...
							echo "<div class='post'>
								...
								<div class='post_container'>
									...
									<div class='profile_indicator'>
										...
										<img src='data:image/jpeg;base64,".base64_encode($row_2['images'])."' class='post_thumbnail'>
									...
									<div class='post_information'>
										...
										<p class='post_name'>".stripslashes($row_2['name'])."</p>
										<p class='post_subject'>".stripslashes($row_2['course'])."</p>

									</div>

								</div>	

								<p class='post_descriptor'>".stripslashes($row_2['post_descriptor'])."</p>
